...
public enum ResponseStatusEnum {
    ...
    STATUS_HAS_EXISTS("A01027", "身份以存在"),
    RELATION_HAS_EXISTS("A01028", "关系以存在"),
    USER_LOGIN_ABNORMAL("A0200", "用户登录异常"),
    ACCOUNT_NOT_EXIST("A0201", "用户账户不存在"),
    PHONE_NOT_EXIST("A0201", "手机号不存在"),
    MAILBOX_NOT_EXIST("A0226", "邮箱不存在"),
    ...
    INCORRECT_PHONE_NUMBER_OR_CAPTCHA("A0225", "手机号或验证码错误"),
    ...
    ACCESS_DENIED_INSUFFICIENT_PERMISSION("A0310", "拒绝访问，权限不足"),
    ...
    THE_EMAIL_VERIFICATION_CODE_IS_INCORRECT("A0607", "邮箱验证码错误"),
    DATA_PRESENCE("A0608", "数据以存在"),

    /*
    错误来源于服务端
     */
    SYS_ERROR("B0001", "服务器内部错误"),
    NON_BUSINESS_LICENSE("B0003", "非营业执照"),
    NON_IDENTITY_CARD("B0004", "非身份证"),
    ...
    THE_REGION_CODE_IS_INCORRECT("B0501", "地区编码错误"),
    ILLEGAL_REQUEST("B0502", "非法请求"),
