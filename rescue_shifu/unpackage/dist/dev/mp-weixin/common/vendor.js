...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__4D7DBA5",
    appName: "rescue_shifu",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.96.1,100.80.60.195,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_dCAyk2";
    ...
    Object.assign(mpPageInstance, {
      ...
      get safeAreaInsets() {
        ...
        return {
          ...
          left: 0,
          right: 0,
          bottom: Math.max(0, safeAreaBottom - screenBottom)
          // 无法计算，
        };
      },
      get pageBody() {
